...
class NormalizeSchemaNameTests(SimpleTestCase):
    ...
    def test_folds_case_hyphens_and_whitespace(self):
        for raw, want in [
            ("acme", "acme"),
            ("  acme  ", "acme"),
            ("Foo-Bar", "foo_bar"),
...
class ValidateSchemaNameTests(SimpleTestCase):
    ...
    def test_accepts_a_leading_digit(self):
    ...
    def test_returns_the_normalized_name(self):
    ...
    def test_rejects_what_cannot_be_normalized(self):
        for raw in [
    ...
    def test_rejects_pg_prefix_case_insensitively(self):
    ...
    def test_over_length_error_explains_the_aliasing_risk(self):
...
class QuoteSchemaTests(SimpleTestCase):
    ...
    def test_quotes_valid_and_legacy_names(self):
    ...
    def test_raises_on_anything_that_could_break_out(self):
    ...
    def test_django_quote_name_alone_would_not_be_safe(self):
...
class TenantCleanSchemaNameTests(SimpleTestCase):
    ...
    def test_does_not_revalidate_an_existing_row(self):
